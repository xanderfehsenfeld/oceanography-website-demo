...
async function loadFiles() {
    let coast = await d3.json("/scripts/jspm/willapagraysharbor/coast_xy.json");
    let tracks = await d3.json("/scripts/jspm/willapagraysharbor/wgh0_tracks.json");
    let times = await d3.json("/scripts/jspm/willapagraysharbor/wgh0_times.json");
