...
<Image
  width={1400}
  height={1800}
  alt="Seattle Tide comparison"
  src="/images/Figs_validation/Seattle.png"
/>
...
<Note type="success">
  ### _You can look at results from all of the 21 stations we use to test tides
  using [this interactive
  map](https://faculty.washington.edu/pmacc/LO/validation_tide.html)._
</Note>
...
<Image
  width={1200}
  height={500}
  alt="Example Ecology Time Series"
  src="/images/Figs_validation/PSB003.png"
/>
...
### _You can explore data from all the CTD stations we use in [this interactive map](/interactive/stations)._
...
<Image
  width={900}
  height={576}
  alt="Summary of CTD Data"
  src="/images/Figs_validation/cas4_v2_lo6biom_7017_CTD_scatter.png"
/>
...
<Image
  width={4150}
  height={2121}
  alt="OCNMS Mooring Record"
  src="/images/Figs_validation/M_2017_CE042_combined_m4.png"
/>
