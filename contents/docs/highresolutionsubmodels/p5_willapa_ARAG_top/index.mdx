...
<div className={'md:flex gap-4 '}>
    <div className={'w-full'}>
        <Video src={'https://s3.kopah.uw.edu/liveocean-web/P1_wgh_ARAG_top.mp4'} width={650}  height={1200}/>
...
contents/docs/highresolutionsubmodels/p5_willapa_ARAG_top/index.mdx
