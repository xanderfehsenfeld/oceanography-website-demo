...
import DriftersWillapaAndGrays, {
  dataFilenames,
} from "./DriftersWillapaAndGrays"

export default async function Pages() {
  const tracksPromise = fetchPoints(dataFilenames.tracks).catch(console.log)
  const timesPromise = fetchTimes(dataFilenames.times).catch((res) => {
    console.log(res)
  })
  return (
          ...
          >
            <DriftersWillapaAndGrays>
              ...
              <p>
                ...
                two clusters of blue dots near the beaches north and south of
                Willapa Bay. The magenta lines show the tracks that the drifters
                take over the full three days, about six tidal cycles.
              </p>
              <p>
                ...
                from the North release site go? or Where did all the particles
              ...
              <p>
                ...
                wetting-and-drying of the intertidal. The particles are tracked
                in 3-D, including dispersion due to turbulence.
              </p>
            </DriftersWillapaAndGrays>
          </SWRConfig>
        </section>
